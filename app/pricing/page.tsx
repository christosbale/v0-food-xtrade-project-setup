        ...
        <section className="py-32">
          <div className="container-boxed">
            <div className="mx-auto max-w-4xl text-center">
              <h1 className="text-display-medium font-bold text-foreground mb-8">
                Supplier Plans
              </h1>
        ...
        <section className="py-24 bg-muted">
          <div className="container-boxed">
            <div className="grid gap-8 lg:grid-cols-3 max-w-7xl mx-auto">
              {/* Basic Plan */}
              <div className="flex flex-col bg-white border border-border p-10 rounded-lg">
                <h3 className="text-headline-small font-bold text-foreground mb-2">
                  Basic
                </h3>
                <p className="text-body-small text-secondary mb-8">
                  Starter Supplier
                </p>
                <div className="mb-12">
                ...
                <ul className="space-y-4 flex-1 mb-12">
                  <li className="flex items-start gap-3">
                    <Check className="h-4 w-4 shrink-0 text-secondary mt-1" />
                ...
                <Link href="/onboarding/supplier?plan=basic">
                  <Button className="w-full h-12 bg-primary text-primary-foreground font-bold hover:bg-primary/90">
                    Get started
                  </Button>
                </Link>
              </div>
              ...
              <div className="flex flex-col bg-[#DDE9F8] border border-border p-10 rounded-lg">
                <h3 className="text-headline-small font-bold text-foreground mb-2">
                  Premium
                </h3>
                <p className="text-body-small text-secondary mb-8">
                ...
                <div className="mb-12">
                  <div className="flex items-baseline gap-2 mb-4">
                    <span className="text-6xl font-bold text-foreground">€199</span>
                    <span className="text-body-medium text-secondary">/ month</span>
                  </div>
                  <p className="text-body-small text-secondary">
